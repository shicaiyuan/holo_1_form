...
class CSphericalHarmonicMap
{
  public:
	...
	double step_one(int steps = 1, double step_length = 1e-2);
     ...
     */
    //void map(double step_length = 1e-2, double epsilon = 1e-3);
	void map(double step_length = 1e-2, double epsilon = 1e-5);
    /*
